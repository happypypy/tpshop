...
<body style="background:#eee">
	...
	<section class="aui-Purchase-content">
		<div class="aui-list-product-box aui-list-product-box-clear" id="con">
			<?php if(is_array($data)): foreach($data as $key=>$d): ?><a href="<?php echo U('Home/Index/goodsdata');?>?id=<?php echo ($d["id"]); ?>" class="aui-list-product-item">
					<div class="aui-list-product-item-img">
						<img src="/Public/Upload/goods/<?php echo ($d["pic"]); ?>" style="height:199.5px;width:199.5px;" alt="">
					</div>
            ...
            $(".type a").click(function() {
                ...
                $.get("<?php echo U('typeinfo');?>",{'id':id},function(res){
                    ...
                    $.each(dataObj, function(index, item){
                        con += '<a href="<?php echo U('Home/Index/goodsdata');?>?id='+item.id+'" class="aui-list-product-item">';
                        con += '<div class="aui-list-product-item-img">';
                        con += '<img src="';
                        con += "/Public/Upload/goods/"+item.pic;
