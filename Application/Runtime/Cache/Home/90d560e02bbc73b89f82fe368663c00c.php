...
<body>
	...
	<header class="aui-header-default aui-header-fixed aui-header-bg">
		...
		<div class="aui-header-center aui-header-center-clear">
			<div class="aui-header-center-logo">
				<div><img src="/Public/Home/img/user/icon-dis.png" alt=""></div>
			</div>
		</div>
	...
	<div class="aui-content-box" style="padding-top:41px;">
		<div class="aui-banner-content aui-fixed-top" data-aui-slider>
			<div class="aui-banner-wrapper">
				<div class="aui-banner-wrapper-item">
					<a href="#">
						<img src="/Public/Home/img/banner/find-2.jpg">
					</a>
				</div>
				<div class="aui-banner-wrapper-item">
					<a href="#">
						<img src="/Public/Home/img/banner/find-1.jpg">
					</a>
				</div>
			</div>
		...
		<section class="aui-card-content">
			<div class="aui-card-box">
				<div class="aui-card-box-user">
					<img src="/Public/Home/img/user/user1.png" alt="">
				</div>
			...
			<div class="aui-card-media">
				<div class="aui-card-media-item">
					<img src="/Public/Home/img/pd/sf-3.jpg" />
				</div>
		...
		<section class="aui-card-content">
			<div class="aui-card-box">
				<div class="aui-card-box-user">
					<img src="/Public/Home/img/user/user4.png" alt="">
				</div>
				<div class="aui-card-box-name">
			...
			<div class="aui-card-media">
				<div class="aui-card-media-item">
					<img src="/Public/Home/img/pd/sf-7.jpg" />
				</div>
				<div class="aui-card-media-inner">
					<div class="aui-card-media-text">
		...
		<section class="aui-card-content">
			<div class="aui-card-box">
				<div class="aui-card-box-user">
					<img src="/Public/Home/img/user/user3.png" alt="">
				</div>
				<div class="aui-card-box-name">
			...
			<div class="aui-card-media">
				<div class="aui-card-media-item">
					<img src="/Public/Home/img/pd/sf-5.jpg" />
				</div>
				<div class="aui-card-media-inner">
					<div class="aui-card-media-text">
		...
		<section class="aui-card-content">
			<div class="aui-card-box">
				<div class="aui-card-box-user">
					<img src="/Public/Home/img/user/user2.png" alt="">
				</div>
				<div class="aui-card-box-name">
			...
			<div class="aui-card-media">
				<div class="aui-card-media-item">
					<img src="/Public/Home/img/pd/sf-8.jpg" />
				</div>
				<div class="aui-card-media-inner">
					<div class="aui-card-media-text">
		...
		<section class="aui-card-content">
			<div class="aui-card-box">
				<div class="aui-card-box-user">
					<img src="/Public/Home/img/user/user0.png" alt="">
				</div>
				<div class="aui-card-box-name">
		...
		<div class="aui-recommend">
			<img src="/Public/Home/img/bg/icon-tj2.jpg" alt="">
			<!--<h2>为你推荐</h2>-->
		</div>
